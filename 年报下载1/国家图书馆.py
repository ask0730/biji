...
"""
中国国家图书馆年报下载脚本
功能：从中国国家图书馆官网下载去年的年报，并重命名为"中国国家图书馆年份年报"格式
"""
...
def main():
    ...
    # 中国国家图书馆年报页面URL
    report_page_url = "https://www.nlc.cn/web/dsb_footer/gygt/xxgk/index.shtml"
    ...
    # 生成文件名，使用实际找到的年份
    filename = f"中国国家图书馆{year_for_filename}年年报.pdf"
    filename = clean_filename(filename)
