select hi_psnjob.pk_psnjob , bd_psndoc.name,bd_psndoc.code,
bd_psndoc.age 年龄,
case when bd_defdoc1.name is null then '其他'
        else bd_defdoc1.name end  政治面貌,
1 as 人数
...
on hi_entryapply.pk_psnjob = hi_psnjob.pk_psnjob 
 ...
 --政治面貌档案
 left join bd_defdoc bd_defdoc1 on bd_psndoc.Polity = bd_defdoc1.pk_defdoc
