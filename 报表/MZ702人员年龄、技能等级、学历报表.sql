...
select 
  ...
  count(distinct case when bd_psndoc.edu.code in ('4','41','42','48','49','5','51','59','6','61','62','68','69','7','71','72','73','78','79','8','81','88','89','99','9') then bd_psndoc.pk_psndoc end) as gzjyx,
  count(distinct case when bd_psndoc.edu.code in ('3','31','38','39') then bd_psndoc.pk_psndoc end) as dxzk,
  count(distinct case when bd_psndoc.edu.code in ('2','21','28','29') then bd_psndoc.pk_psndoc end) as dxbk,
  count(distinct case when bd_psndoc.edu.code in ('1','14','15','16','17','18','19') then bd_psndoc.pk_psndoc end) as ss,
  count(distinct case when bd_psndoc.edu.code in ('0','11','12','13') then bd_psndoc.pk_psndoc end) as bs,
